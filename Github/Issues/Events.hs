...
eventsForIssue :: String -> String -> Int -> IO (Either Error [RepositoryEvent])
...
eventsForRepo :: String -> String -> IO (Either Error [RepositoryEvent])
...
event :: String -> String -> Int -> IO (Either Error RepositoryEvent)
